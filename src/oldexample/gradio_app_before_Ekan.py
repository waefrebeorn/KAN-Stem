...
def preprocess_audio(audio_file_path, target_length=30):  # Reduce target length
    ...
    try:
        ...
        chunks = torch.split(waveform, sample_rate)  # 1-second chunks
...
def calculate_num_examples(memory_gb, duration_sec=30, num_stems=5, sample_rate=44100):
